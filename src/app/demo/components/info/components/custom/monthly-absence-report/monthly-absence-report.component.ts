...
import { MonthlyAbsenceReportService } from './monthly-absence-report.service';
@Component({
    selector: 'app-monthly-absence-report',
    standalone: true,
    imports: [GlobalsModule, PrimeNgModule],
    providers: [MessageService],
    templateUrl: './monthly-absence-report.component.html',
    styleUrl: './monthly-absence-report.component.scss',
})
export class MonthlyAbsenceReportComponent {
    constructor(
