...
export class ApplyingInternalJobComponent {
  ...
  loadData(
    ...
    this._ApplyingInternalJobService.GetPage(filteredData).subscribe({
      next: (res) => {
        console.log(res);
  ...
  saveProduct(form: FormGroup, product: any) {
    ...
    this._ApplyingInternalJobService.Edit(form.value).subscribe({
      next: (res) => {
        if (res.success) {
          this.hideDialog();
          // show message for user to show processing of deletion.
  ...
  confirmDeleteSelected() {
    ...
    this._ApplyingInternalJobService.DeleteRangeSoft(selectedIds).subscribe({
      next: (res) => {
