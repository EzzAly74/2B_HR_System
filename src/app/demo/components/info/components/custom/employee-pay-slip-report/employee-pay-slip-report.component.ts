...
import { EmployeePaySlipReportService } from './employee-pay-slip-report.service';
...
@Component({
    selector: 'app-employee-pay-slip-report',
    standalone: true,
    imports: [GlobalsModule, PrimeNgModule],
    providers: [MessageService],
    templateUrl: './employee-pay-slip-report.component.html',
    styleUrl: './employee-pay-slip-report.component.scss',
})
export class EmployeePaySlipReportComponent {
    constructor(
    ...
    ngOnInit() {
        ...
        Globals.getMainLangChanges().subscribe((mainLang) => {
            ...
            this._EmployeePaySlipReportService.setCulture(mainLang);

            // update endpoint
            this._EmployeePaySlipReportService.setEndPoint(this.endPoint);
    ...
    editProduct(rowData: any) {
        this._EmployeePaySlipReportService.GetById(rowData.id).subscribe({
            next: (res) => {
    ...
    confirmDelete(id: number) {
        ...
        this._EmployeePaySlipReportService.deleteById(id).subscribe({
            next: () => {
                // close dialog
    ...
    addNew(form: FormGroup) {
        // Confirm add new
        this._EmployeePaySlipReportService.Register(form.value).subscribe({
            next: (res) => {
                console.log(res);
    ...
    loadData(
        ...
        this._EmployeePaySlipReportService.GetPage(filteredData).subscribe({
            next: (res) => {
                console.log(res);
    ...
    saveProduct(id: number, form: FormGroup) {
        ...
        this._EmployeePaySlipReportService.Edit(form.value).subscribe({
            next: (res) => {
                this.hideDialog();
                // show message for user to show processing of deletion.
                if (res.success) {
    ...
    confirmDeleteSelected() {
        ...
        this._EmployeePaySlipReportService.DeleteRange(selectedIds).subscribe({
            next: (res) => {
    ...
    getDropDowns() {
        this._EmployeePaySlipReportService.getMonths().subscribe({
            next: (res) => {
        ...
        this._EmployeePaySlipReportService
    ...
    getAllData(body: any) {
        this._EmployeePaySlipReportService.GetPage(body).subscribe({
            next: (res) => {
                console.log(res);
