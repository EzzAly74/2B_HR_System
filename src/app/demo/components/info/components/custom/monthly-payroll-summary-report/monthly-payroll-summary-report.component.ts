...
export class MonthlyPayrollSummaryReportComponent {
    constructor(
    ...
    ngOnInit() {
        ...
        Globals.getMainLangChanges().subscribe((mainLang) => {
            ...
            this._MonthlyPayrollSummaryReportService.setCulture(mainLang);

            // update endpoint
            this._MonthlyPayrollSummaryReportService.setEndPoint(this.endPoint);
    ...
    editProduct(rowData: any) {
        this._MonthlyPayrollSummaryReportService.GetById(rowData.id).subscribe({
            next: (res) => {
    ...
    confirmDelete(id: number) {
        ...
        this._MonthlyPayrollSummaryReportService.deleteById(id).subscribe({
            next: () => {
                // close dialog
    ...
    addNew(form: FormGroup) {
        // Confirm add new
        this._MonthlyPayrollSummaryReportService
            .Register(form.value)
            .subscribe({
                next: (res) => {
                    console.log(res);
    ...
    saveProduct(id: number, form: FormGroup) {
        ...
        this._MonthlyPayrollSummaryReportService.Edit(form.value).subscribe({
            next: (res) => {
                this.hideDialog();
                // show message for user to show processing of deletion.
                if (res.success) {
    ...
    getDropDowns() {
        this._MonthlyPayrollSummaryReportService.getMonths().subscribe({
            next: (res) => {
    ...
    getAllData(body: any) {
        this._MonthlyPayrollSummaryReportService.GetPage(body).subscribe({
            next: (res) => {
                console.log(res);
